...
(45, 3, 'Coffee Mocha', 'Mocha cafe', 'Cà phê Mocha là cà phê được tạo ra từ cà phê espresso và sữa nóng, có thêm bột hoặc nước sốt socola.', '2023-04-22 19:04:58', '2023-04-22 19:04:58', 0, 'Mochacafe', 1, 2, 3),
(46, 3, 'Capuccino', 'Capuccino', 'A cappuccino is an espresso-based coffee drink and is traditionally prepared with steamed milk foam (microfoam)', '2023-04-22 19:47:46', '2023-04-22 19:47:46', 0, 'capuccino', 1, 2, 3),
(47, 1, 'Cake Custard', 'Bánh bông lan', 'Cake is a traditional cake made from ingredients such as flour, baking powder, eggs, milk, sugar combined with many other ingredients.', '2023-04-22 19:05:15', '2023-04-22 19:05:15', 0, 'Banhbonglan', 1, 2, 3),
(48, 1, 'Cake donut ice', 'Bánh donut kem trứng', 'Donut is a delicious cake with a creamy filling inside a crispy crust', '2023-04-22 20:13:37', '2023-04-22 20:13:37', 0, 'Banhdonutkemtrung', 1, 2, 3),
(73, 2, 'Tea Fresh milk', ' Trà sữa trân châu trắng', 'White pearl milk tea has always been a favorite drink of many people since its appearance on the Vietnamese market until now.', '2023-04-22 18:29:33', '2023-04-22 18:29:33', 0, 'Trasuatranchautrang', 1, 2, 3),
(74, 2, 'Tea Taro Milk', 'Trà sữa khoai môn', 'Taro milk tea is a delicious drink with fresh taro flavor that is popularly used in big brands such as Gongcha, Bobapop, Tocotoco.', '2023-04-22 19:05:42', '2023-04-22 19:05:42', 0, 'Trasuakhoaimon', 1, 2, 3),
(75, 2, 'Tea Mist Milk', 'Trà sữa sương sáo', 'Dew flute milk tea is a cool milk tea dish, great for cooling off on hot summer days.', '2023-04-22 19:05:59', '2023-04-22 19:05:59', 0, 'Trasuasuongsao', 1, 2, 3),
(76, 2, 'Tea Butterfly Pea', 'Trà sữa hoa đậu biếc', 'Butterfly pea flower milk tea is an attractive drink, attracting people to enjoy with the greasy, acrid taste of milk tea, the faint aroma and especially the characteristic blue-violet color from the butterfly pea flower.', '2023-04-22 18:58:49', '2023-04-22 18:58:49', 0, 'Trasuahoadaubiec', 1, 2, 3),
(77, 1, 'Cake Pancake', 'Bánh Pancake.', 'Pancake is a flat, thin and round cake made from basic ingredients including flour, eggs, milk and butter.', '2023-04-22 18:59:28', '2023-04-22 18:59:28', 0, 'Pancake', 1, 2, 3);
...
(1, 'admin', 'admin@gmail.com', '0987654321', 'admin', '123456789', 1, NULL, NULL, 0),
(2, 'nam12345', 'user@gmail.com', '0778899221', 'user', '987654321', 2, NULL, NULL, 0);
...
INSERT INTO `contact` (`ID`, `Name`, `Email`, `PhoneNumber`, `SubjectName`, `Message`) VALUES
(1, 'namnguyen', 'nam123456@gmail.com', '0123456789', 'abc', 'abc');
